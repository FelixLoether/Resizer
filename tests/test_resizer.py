...
@contextmanager
def fake_image_context(full_cleanup=False):
    import resizer.resizer
    global fake_image_stack
...
class TestResizerInternalMethods(object):
    ...
    def test_handle_resize_adaption_gets_projected_size(self):
        ...
        with fake_image_context(full_cleanup=True):
    ...
    def test_handle_resize_adaption_creates_an_image(self):
        ...
        assert fake_image_stack.pop().source is resized_source
        assert len(fake_image_stack) == 0
